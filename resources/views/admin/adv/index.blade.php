        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
            ...
            <div class="dataTables_filter" id="DataTables_Table_1_filter">
                <label>
                    ...
                    <input type="text" name='gtitle' value="{{$request->gtitle}}" aria-controls="DataTables_Table_1">
            ...
            aria-describedby="DataTables_Table_1_info">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <!-- <tr class='@if($k % 2 == 0) odd @else even @endif'> -->
                        ...
                        <td class="gpic">
                            <img src="{{$v->gpic}}" alt="" width='80px'>
                        </td>
                        
                        <td class=" ">
                            <a href="/admin/adv/{{$v->id}}/edit" class='btn btn-info'>修改</a>

                            <form action="/admin/adv/{{$v->id}}" method='post' style='display:inline'>
                                {{csrf_field()}}
